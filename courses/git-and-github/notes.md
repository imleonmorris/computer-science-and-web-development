...
1. Fixing a typo
2. Fixing a bug
3. NB: The above two should be committed separately/
...
git fetch updates the local copy of the remote without changing the local HEAD of the repo. GitHub stores a local copy of the remote. 
